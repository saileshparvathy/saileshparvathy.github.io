...
[![PDF icon](/images/PDF_icon.png){:style="height:36px; margin-right:4px;"} PDF]({{ 'files/chinaindiabrief.pdf' | relative_url }}), [Link](https://lkyspp.nus.edu.sg/cag/publications/center-publications/publication-article/detail/made-in-china--make-in-india--bilateral-economic-relations-reimagined-through-industrial-policy)  
...
[![PDF icon](/images/PDF_icon.png){:style="height:36px; margin-right:4px;"} PDF]({{ 'files/Dissertation_sample.pdf' | relative_url }})   
